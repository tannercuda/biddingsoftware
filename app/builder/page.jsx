  ...
  return (
    <div className="card">
      ...
      <div className="cardHeader">
        <div>
          <h1>Builder Portal</h1>
          <div className="hint">Go to Setup or Bid Analysis.</div>
        </div>
      ...
      <div className="grid3">
        <div className="card" style={{margin:0}}>
          <h2>Setup</h2>
          <div className="hint">Choose trades, define bid format, manage documents.</div>
          <div style={{marginTop:12}}><a className="btn good" href="/builder/setup">Open Setup →</a></div>
        </div>
        <div className="card" style={{margin:0}}>
          <h2>Bid Analysis</h2>
          <div className="hint">Compare vendors per trade & plan. Low is Avg/Plan.</div>
          <div style={{marginTop:12}}><a className="btn good" href="/builder/analysis">Open Bid Analysis →</a></div>
        </div>
        <div className="card" style={{margin:0}}>
          <h2>Sub View</h2>
          <div className="hint">Open subcontractor portal (what vendors see).</div>
          <div style={{marginTop:12}}><a className="btn" href="/sub">Open Sub →</a></div>
        </div>
      </div>
    </div>
  );
