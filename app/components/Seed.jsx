...
function defaultConfig(){
  return { communityId: demo.communityId, communityName: demo.communityName, communityCode: demo.communityCode, plans: demo.plans, tradesNeeded: ["trade1","trade2","trade3","trade4","trade5","trade6"] };
}
...
function seedBidsOnce(){
  const existing=readLS(LS_KEYS.BIDS,null); if(existing) return;
  writeLS(LS_KEYS.BIDS,[
    {bidId:uid("bid"),communityId:demo.communityId,vendorId:"v-seeded-sunrise",vendorName:"Sunrise Concrete",tradeId:"trade1",status:"submitted",submittedAt:nowISO(),format:{mode:"lumpsum"},lumpsumByPlan:{plan1:3200,plan2:3450,plan3:3600,plan4:3725},lineItems:[],notes:"Includes standard flatwork. Excludes permits."},
    {bidId:uid("bid"),communityId:demo.communityId,vendorId:"v-seeded-timberline",vendorName:"Timberline Framing",tradeId:"trade2",status:"submitted",submittedAt:nowISO(),format:{mode:"lumpsum"},lumpsumByPlan:{plan1:9800,plan2:10250,plan3:10750,plan4:11200},lineItems:[],notes:"Includes labor + nails. Excludes crane."}
  ]);
}
