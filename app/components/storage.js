...
export function uid(prefix="id"){ return prefix+"-"+Math.random().toString(16).slice(2)+"-"+Date.now().toString(16); }
...
export function sumObjValues(obj){ return Object.values(obj||{}).reduce((a,b)=>a+(Number(b)||0),0); }